...
#include<string.h>
#include<stdlib.h>
int sett=0,operand=0,oper=0;
float count=0,megacount=0;
int lines=0;
void totlines()
{
  FILE *pq=fopen("additional.txt","r");
  char w[200];
  while(!feof(pq))
  {
    fgets(w,199,pq);
    ...
    char name[200],text[200];
	 ...
	 //   printf("111%s",name);
      ...
      //  printf("%s \n",text);
        ...
        printf("average life for variable %s is %d\n",name,count/lines);
	      fgets(name,199,in);
	//	printf("%s hhhhhh\n",name);
	   }
	  fclose(fp);
...
int main()
{
 ...
 printf("megacount = %f lines = %f ",megacount,lines);
 printf("average life of live varibles in the file is %f\n",megacount/lines);
